...
//! drives. `cargo xtask bench ab --ref HEAD --replicates 6 --package
//! spate-bench` compares this target against itself and must flag nothing. A
//! flag there means the harness is measuring its own noise rather than the code
//! under test.
//!
