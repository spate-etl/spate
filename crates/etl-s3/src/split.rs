...
use etl_core::coordination::{CoordinationError, CoordinationErrorKind, SplitId};
...
/// [`SplitSpec::descriptor`](etl_core::coordination::SplitSpec): the
...
///    - the domain tag: the 13 ASCII bytes `etl-s3-split\n`;
...
mod tests {
    ...
    fn digest_id_is_pinned() {
        ...
        .unwrap();
        assert_eq!(id.as_str(), "s3-Q-kFH2L7NbRCOZEQJ7acFw");
    }
