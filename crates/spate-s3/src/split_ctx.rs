...
//! [`SplitSource`](spate_core::coordination::driver::SplitSource) callbacks.
//!
//! [`SplitCtx`] lives beside the
//! [`CoordinationDriver`](spate_core::coordination::driver::CoordinationDriver)
...
struct SplitState {
    ...
    /// Cooperative-revocation stop flag shared with the fetcher: set once by
    /// [`begin_revoke`](SplitCtx::begin_revoke), it makes the fetcher return
