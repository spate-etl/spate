...
A broker-less source such as an object-storage backfill has no consumer group to
...
cannot oscillate. Unlike a fair-share gate, it also cannot starve a newcomer,
