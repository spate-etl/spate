...
- [Memory connectors](../04-connectors/memory.md) — the same mocks as
  local-dev connectors.
- [Assembling a pipeline](assembling-a-pipeline.md) — the builder steps
  used above.
- [Delivery guarantees](../02-concepts/02-delivery-guarantees.md) — why
