...
episode rather than how many must succeed. Per-shard workers
...
[**`settings` passthrough**](#the-settings-passthrough-and-the-denylist) — they are not among
...
`component_type="clickhouse"`. Most are per shard; the three replica-level
