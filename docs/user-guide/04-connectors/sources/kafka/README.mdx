...
- [Monitoring](../../../05-deployment/monitoring.mdx) — consumer lag and
  backpressure metrics; the connector's own librdkafka-statistics families
  (`spate_kafka_source_*`) are documented in [Metrics](../../../../METRICS.md).
