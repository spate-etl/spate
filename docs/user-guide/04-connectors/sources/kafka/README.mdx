...
- `spate_kafka_source_partition_not_fetching == 1` — the member holds the
  ...
  assignment, a healthy group and no error anywhere. This one wants a `for:`
