...
- Connector configuration bodies: [Kafka](../04-connectors/kafka.mdx),
  [ClickHouse](../04-connectors/clickhouse/README.mdx),
  [Avro](../04-connectors/avro/README.mdx), [Memory](../04-connectors/memory.mdx).
