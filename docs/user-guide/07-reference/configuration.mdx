...
|---|---|---|
| `source` | yes | [Kafka](../04-connectors/kafka.mdx), [Memory](../04-connectors/memory.mdx), or your own ([Custom sources](../06-extending/custom-source.mdx)) |
| `deserializer` | no — sources that emit ready-made records need none | [Avro](../04-connectors/avro/README.mdx) |
| `sink` **or** `sinks` | yes (exactly one) | [ClickHouse](../04-connectors/clickhouse/README.mdx), [Memory](../04-connectors/memory.mdx), or your own ([Custom sinks](../06-extending/custom-sink.mdx)) |
...
[Tuning](../05-deployment/tuning.mdx) for how to size them.
...
[ClickHouse multi-table](../04-connectors/clickhouse/multi-table.mdx) for the
