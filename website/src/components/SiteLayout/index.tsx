...
/**
 * The layout of the marketing pages: the site navbar and footer around a
 * full-width main, inside the theme's providers so colour mode, search and
 * code blocks work as they do on a docs page.
 */
