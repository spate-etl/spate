...
export function faq(msrv: string, edition: string): Array<{q: string; a: string}> {
  return [
    {
    ...
    },
    {
      ...
      a: `The minimum supported Rust version is ${msrv} with edition ${edition}. The newest 0.x minor is the supported line, and breaking changes ship in a minor bump.`,
    },
    {
